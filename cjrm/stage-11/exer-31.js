...
const myName = ['an', 'drew']
const myName2 = ['Jo', 'se']
const myName3 = ['Pa', 'ra', 'le', 'le', 'pi', 'pe', 'do']

const languageP = (name) =>
  name.reduce((acc, syllable) => `${acc}P${syllable}`, '')

console.log(languageP(myName))
console.log(languageP(myName2))
console.log(languageP(myName3))
...
console.log(getOccurences(scores, 1))

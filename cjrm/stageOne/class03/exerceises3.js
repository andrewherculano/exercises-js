...
const popNameDogs = dogNames.pop('Matilda')
console.log(popNameDogs)

const lastNameDogs = dogNames[dogNames.length - 1]
console.log(lastNameDogs)
...
console.log(`A ${dessert.replace('n', 'd').toLocaleUpperCase()} é um doce à base de coco, tradicional na América Latina e em Angola.`)

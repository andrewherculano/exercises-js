...
const showGames = cart.reduce((accumulator, item) => {
...
const moviesYearLess2000 = tarantinoMovies.filter(({release}) => release < 2000);
console.log(moviesYearLess2000);
...
const showNamesTvShows = tvShows.map(({name}) => name)

console.log(showNamesTvShows)

...
const numcaracters = 39
let booleanMessage = typeSentence.length >= numcaracters

booleanMessage = String(booleanMessage).replace('t', 'T')

console.log(`A string que a "typeSentence" armazena tem mais de ${numcaracters} caracteres? ${booleanMessage}.`)

...
const convertToString = value => typeof String(value)
...
const countCharacter = string => string.length
...
console.log(convertToLowerCase(phrase))
...
const indexCharacterInString = (caracter, string) => string.indexOf(caracter)

console.log(indexCharacterInString('c', 'abcdefg'))
...
const checkItemInArray = (item, array) => array.includes(item)

console.log(checkItemInArray('b', ['g', 'b', 'a']))
...
const crazyArray = ['Harry Potter', 'Alvo Dumbledore', 'Dobby', 'Will Smith']
...
console.log(removeLastItem(crazyArray))
...
const myName = () => console.log('Andrew Herculano')
...
const likesNames = ['Will', 'Chris', 'Dumbledore', 'Yoda', 'Hulk']  

const likesInPost = likes => {
  ...
  switch(likes.length) {
    ...
    default:
      return `${firstName}, ${secondName} e mais ${likes.length - 2} pessoas curtiram isso`
  }
}

console.log(likesInPost(likesNames))
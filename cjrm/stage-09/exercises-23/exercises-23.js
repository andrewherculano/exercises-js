...
const animalsLengthThree = animals.filter(({ length }) => length === 3);

console.log(animalsLengthThree);
...
const animalsLength = animals.map(({ length }) => length);

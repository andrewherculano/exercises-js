...
const handleSubmit = event => {
    ...
    inputValue = event.target.input

    // const patternInput = /.{7,}/
    const patternInput = /[a-zA-Z0-9]{7,11}/
    const isAMatchInput = patternInput.test(inputValue.value)
...
const result = pattern.test(textParagraph)
...
const partternOne = /[B+99]{3}/
const isAMatchB99 = partternOne.test(B99message)

console.log(isAMatchB99)
